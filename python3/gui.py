...
class FrontEnd:
    def __init__(self, filename=None):
        ...
        self.button_bar.pack_start(self.split_button, True, True, 0)

        self.filename.pack_start(self.filename_label, True, True, 0)
        self.filename.pack_start(self.filename_entry, True, True, 0)

        self.vbox_main.pack_start(self.button_bar, True, True, 0)
        self.vbox_main.pack_start(self.filename, True, True, 0)
        self.vbox_main.pack_start(self.add_button, True, True, 0)
        self.vbox_main.pack_start(self.tracks, True, True, 0)
    ...
    def add_track(self, obj=None):
        ...
        hbox.pack_start(start_label, True, True, 0)
        hbox.pack_start(start, True, True, 0)
        hbox.pack_start(stop_label, True, True, 0)
        hbox.pack_start(stop, True, True, 0)
        hbox.pack_start(button, True, True, 0)

        self.tracks.pack_start(hbox, True, True, 0)
    ...
    def remove_track(self, obj):
        obj.get_parent().get_parent().remove(obj.get_parent())
    ...
    def split_file(self, obj):
        ...
        except (IOError, ValueError) as emsg:
